...
module "container_registry" {
  source     = "git::https://github.com/wri/gfw-terraform-modules.git//terraform/modules/container_registry?ref=v0.4.2.8"
...
module "lambda_raster_tiler" {
  ...
  environment = var.environment
  lambda_layers = [
    local.core.lambda_layers.py310_numpy_1264_arn,
    local.core.lambda_layers.py310_pillow_950_arn,
    local.core.lambda_layers.py310_rasterio_no_numpy_arn,
    local.core.lambda_layers.py310_mercantile_121_arn
  ]
