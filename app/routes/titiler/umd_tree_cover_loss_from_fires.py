...
async def umd_tree_cover_loss_raster_tile(
    *,
    ...
    start_year: Optional[int] = Query(
        TreeCoverLossFromFires.DEFAULT_START_YEAR,
        ge=TreeCoverLossFromFires.DEFAULT_START_YEAR,
        le=TreeCoverLossFromFires.DEFAULT_END_YEAR,
        description="Only show loss for given year and after",
    ),
    end_year: Optional[int] = Query(
        TreeCoverLossFromFires.DEFAULT_END_YEAR,
        ge=TreeCoverLossFromFires.DEFAULT_START_YEAR,
        le=TreeCoverLossFromFires.DEFAULT_END_YEAR,
